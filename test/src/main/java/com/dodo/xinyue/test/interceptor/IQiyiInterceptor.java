 ...
 * @date 2018/9/20
 */
public class IQiyiInterceptor extends BaseInterceptor {

    @Override
    public Response intercept(Chain chain) throws IOException {
        final Request original = chain.request();
        final String url = original.url().toString();
        if (url.contains("iface2.iqiyi.com")) {
            ...
            final Request request = original.newBuilder()
                    ...
                    .header("sign", "285ec0a7a749975c558ed0b2a7821807")
                    .header("t", "429435078")
                    .header("qyid", "868359031985428_1663ba4374a5c8b7_04Z50ZDAZ12ZF9Z24")
                    .header("Host", "iface2.iqiyi.com")
//                    .header("Accept-Encoding", "gzip")
//                    .method(original.method(), RequestBody.create(MediaType.parse("application/json"), ""))
                    .build();
